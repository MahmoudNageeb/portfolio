...
const projects: Proj[] = [
  ...
  { year: "2023", company: "شركة جلوبال", area: "الفروانية — المنطقة الثانية (تجديد)", ministry: "وزارة التربية", system: "قاعدة بيانات إصدار أوامر العمل والفواتير", cat: "تربية" },
  ...
  { year: "2025", company: "شركة تيك نت كويت", area: "الأحمدي (صيانة جذرية)", ministry: "وزارة الأوقاف", system: "قاعدة بيانات إصدار التكاليف", cat: "أوقاف" },
  { year: "2025", company: "شركة بوت كولرز", area: "حولي (صيانة جذرية)", ministry: "وزارة الأوقاف", system: "قاعدة بيانات إصدار التكاليف", cat: "أوقاف" },
  { year: "2025", company: "شركة دامور", area: "حولي (صيانة جذرية)", ministry: "وزارة الأوقاف", system: "قاعدة بيانات إصدار التكاليف", cat: "أوقاف" },
  ...
  // وزارة الصحة
  { year: "—", company: "شركة المنذر العقارية", area: "المستشفيات (تجديد)", ministry: "وزارة الصحة", system: "قاعدة بيانات أعمال الصيانة", cat: "صحة" },
];

...
const jobs = [
  {
    ...
    dc: "dot-c", dtc: "dt-c",
    role: "رئيس الحسابات + مدير قسم الموارد البشرية + معاملات التصنيف بالجهاز المركزي للمناقصات العامة وجميع المعاملات الحكومية بوزارة التجارة و الصناعة و جميع الوزارات و الهيئات المختلفة ",
